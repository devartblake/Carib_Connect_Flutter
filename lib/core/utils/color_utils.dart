...
class ColorUtils {
  static Color shiftHsl(Color c, [double amt = 0]) {
    ...
    return hslColor.withLightness((hslColor.lightness + amt).clamp(0.0, 1.0)).toColor();
  }

  /// Color HEX value parsing
...
/// Get the different MaterialColors
