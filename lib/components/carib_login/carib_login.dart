...
import '../../../data/models/login/user_form_field.dart';
export '../../../data/models/login/login_data.dart';
export '../../../data/models/login/login_user_type.dart';
export '../../../data/models/login/signup_data.dart';
export '../../../data/models/login/terms_of_service.dart';
export '../../../data/models/login/user_form_field.dart';
import '../../core/constants/auth.dart';
export '../../core/constants/auth.dart';
export '../../core/constants/login_theme.dart';
import '../../core/constants/login_theme.dart';
import '../../core/constants/login_messages.dart';
export '../../core/constants/login_messages.dart';
import '../../../components/carib_login/cards/auth_card_builder.dart';
import '../../../components/carib_login/fade_in.dart';
import '../../../components/carib_login/gradient_box.dart';
import '../../../components/carib_login/hero_text.dart';
...
class __HeaderState extends State<_Header> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.logoTag != null) {
      logo = Hero(tag: widget.logoTag!, child: logo);
    }
...
class FlutterLogin extends StatefulWidget {
  FlutterLogin({
    ...
    this.termsOfService = const <TermsOfService>[],
  ...
  /// shown in the demo gifs and use the colorscheme in the closest `Theme`
  /// widget
  ...
  /// release mode, this will be overridden to false regardless of the value
  /// passed in
  ...
  /// Hide the title above the login providers. If no providers are set this is ineffective
  ...
  final List<TermsOfService> termsOfService;
...
class _FlutterLoginState extends State<FlutterLogin>
  ...
  Widget build(BuildContext context) {
    ...
    return MultiProvider(
      providers: [
        ChangeNotifierProvider.value(value: widget.messages ?? LoginMessages()),
        ChangeNotifierProvider.value(value: widget.theme ?? LoginTheme()),
