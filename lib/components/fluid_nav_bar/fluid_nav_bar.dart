...
import '../../core/utils/math/curves.dart';
...
class FluidNavBar extends StatefulWidget {
  ...
  /// An optional builder to change or wrap the built item
  ///
  ...
  Widget _buildBackground() {
    return Container(
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(widget.style?.borderRadius ?? 0.0),
  ...
  List<Widget> _buildButtons() {
    var buttons =  widget.icons
      ...
      return Tooltip(
        ...
        .toList();
    // Reverse buttons for RTL layouts
...
class _BackgroundCurvePainter extends CustomPainter {
  ...
  void paint(canvas, size) {
    ...
    // Point co-linear to the top edge of the background pane
